CREATE OR REPLACE PROCEDURE BL_CL.CREATE_PARTITIONS_FOR_FCT_SALES (
    START_YEAR INT,
    END_YEAR   INT
) IS
...
BEGIN
    FOR CURRENT_YEAR IN START_YEAR..END_YEAR LOOP
        FOR CURRENT_MONTH IN 1..12 LOOP
            ...
            SQL_STATEMENT := 'ALTER TABLE fct_sales
                ADD PARTITION '
                             || PARTITION_PREF
...
EXEC BL_CL.CREATE_PARTITIONS_FOR_fct_SALES(2020,2021)